...
def cash(start_date,end_date):
     ...
     #    adte = date.today()
        file1 = open(f"J:\India\BBR\2023\BBR_20230115\Bank\{start_date2}-BOFA Bulk.pdf","rb")
        file2 = open(f"J:\India\BBR\2023\BBR_20230115\Bank\{start_date2}-BOFA Rack.pdf","rb")
        file3 = open(f"J:\India\BBR\2023\BBR_20230115\Bank\{start_date2}-RCP South BOFA.pdf","rb")
        file4 = open(f"J:\India\BBR\2023\BBR_20230115\Bank\{start_date2}-RCP Midwest.pdf","rb")
        file5 = open(f"J:\India\BBR\2023\BBR_20230115\Bank\{start_date2}-BOFA-BU Export.pdf","rb")
        file6 = open(f"J:\India\BBR\2023\BBR_20230115\Bank\{start_date2}-BOFA-BioUrja Nehme Commodities.pdf","rb")
        file7 = open(f"J:\India\BBR\2023\BBR_20230115\Bank\{start_date2}-BOFA-BioUrja Energy Commodities.pdf","rb")
        file8 = open(f"J:\India\BBR\2023\BBR_20230115\Bank\{start_date2}-RCP Holdings.pdf","rb")
        file9 = open(f"J:\India\BBR\2023\BBR_20230115\Bank\{start_date2}-RCP South Chase.pdf","rb")
        file10 = open(f"J:\India\BBR\2023\BBR_20230115\Bank\{start_date2}-CHASE Bulk.pdf","rb")
        file11 = open(f"J:\India\BBR\2023\BBR_20230115\Bank\{start_date2}-CHASE Rack.pdf","rb")
        wb = xw.Book(f"J:\India\BBR\2023\BBR_20230115\BioUrja - Consolidated Borrowing Base Syndication {start_date}_Working.xlsx")
        retry = 0
        while retry < 10:
            try:
                wb = xw.Book("C:\DEEPFOLDER\Tasks\BBR_PROCESS\BioUrja - Consolidated Borrowing Base Syndication 11.30.2022_Working.xlsx")
